/** 
 * Builds a singly linked list with generics of size 5 and prints it to the console.
 * 
 * @author Jochen Lang
 */

class LinkList<E> extends GNode<E>{
	private GNode<E> llist;
    ...
    public void print() {
	/* Print the list */
	GNode<E> current = llist; // point to the first GNode
	while (current != null) {
